...
def descubrir_tours(
    ...
    while (
        ...
        # El descubrimiento usa el navegador porque muchos operadores
        # cargan las tarjetas y enlaces de actividades con JavaScript.
        # Requests se mantiene para la extracción individual, donde sí
        # resulta útil como alternativa más rápida.
...
def extraer_tour(
    ...
    try:
        ...
        print(
            ...
            f"{error_playwright}. Usando HTML básico."
        )
        respuesta = requests.get(
            url,
            headers=HEADERS,
